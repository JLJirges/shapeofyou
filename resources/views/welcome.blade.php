...
@section('content')
    ...
    <div class="home_section goal_bg">
        ...
        <div class="home_section_goals_content">
            ...
            <div id="goal-tab-2" class="tab-content">
                <strong>FITNESS</strong>Are you thinking about running a Marathon or just noticed you'd like to be able to take the stairs
            ...
            <div id="goal-tab-3" class="tab-content">
                <strong>MUSCLE WORK</strong>You are already fit and have a healthy lifestyle, but now it's time to define your body or add some
            ...
            <div id="goal-tab-4" class="tab-content">
                <strong>HEALTH</strong> Pizza, Burger, Fries and Coke! No thanks, those times are over! If your goal is a healthier
    ...
    <div class="home_section shape_bg">
        <div class="welcome_shape_content">
