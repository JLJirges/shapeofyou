        ...
        <ol class="help_ol">
            ...
            <li>
                ...
                <p>In here you can find Community Members of all kind! Your Workout Buddies, Users with a vegan diet,
                    pescetarian diet, goal to lose weight...well, you get the point. You can also scroll at the bottom
                    of
            ...
            <li>
                ...
                <p>Oh the Meetups! Where people meet to celebrate, drink, dance, run, communicate. We will throw some
                    (party) events from time to time, so make sure, you get one of our limited tickets in time! You can
                    also
            ...
            @if(Auth::user()->isAdmin === 1)
                <li>
                    <h4>Backend</h4>
                    <p>In the Backend you can act like a magician! View all Users, Diaries, Before After Stories (we
                        just
                        call it BAS), Workouts, Blogs, Events, whatever! In create, you can create whatever you want!
                        Just
