                ...
                <div class="box_outdoor">
                    <a href="@if( (auth()->check())){{url('overview/1')}}@else{{ url ('register') }}@endif">
                        <svg viewbox="0 -1 50 47.4">
                            ...
                            <rect x="0.5" y="0.5" width="220" height="215" mask="url(#warmup_mask)" fill-opacity="1" fill="rgba(255, 255, 255, 0.9)"/>
                        </svg>
                    </a>
                </div>
            @endif
                    ...
                    <div class="box_stretch">
                        <a href="@if( (auth()->check())){{url('overview/2')}}@else{{ url ('register') }}@endif">
                            <svg viewbox="0 -1 50 47">
                                ...
                                <rect x="0.5" y="0.5" width="220" height="215" mask="url(#stretch_mask)" fill-opacity="1" fill="rgba(000, 000, 000, 0.9)"/>
                            </svg>
                        </a>
                    </div>
                @endif
                ...
                <div class="box_indoor">
                    <a href="@if( (auth()->check())){{url('overview/3')}}@else{{ url ('register') }}@endif">
                        <svg viewbox="0 -1 50 47">
                            ...
                            <rect x="0.5" y="0.5" width="220" height="205" mask="url(#mainworkout_mask)" fill-opacity="1" fill="rgba(255, 255, 255, 0.9)"/>
                        </svg>
